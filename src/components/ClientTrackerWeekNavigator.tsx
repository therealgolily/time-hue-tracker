...
import { ClientDayData } from '@/types/clientTracker';

interface ClientTrackerWeekNavigatorProps {
  selectedDate: Date;
...
export const ClientTrackerWeekNavigator = ({
  selectedDate,
  onSelectDate,
  onPreviousWeek,
  onNextWeek,
  weekStart,
  getDayData,
}: ClientTrackerWeekNavigatorProps) => {
